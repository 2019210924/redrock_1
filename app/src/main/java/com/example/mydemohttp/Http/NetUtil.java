...
public class NetUtil {
    ...
    public void execute(Request request, final com.example.mydemohttp.Http.Callback callback) {
        //初始化网络请求参数
            ...
            public void run() {
                ...
                if(method.equals("GET")){
                   ...
                   doGet(url,"1",contentType);
                    ...
                    doPost(url,data,contentType);
                }
            }
        });
    }

        public static String doGet(String geturl,String params,String contentType) {
    ...
    public static String doPost(String posturl,String data,String contentType) {
